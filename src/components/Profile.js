...
function Profile() {
  ...
  useEffect(()=>{
    ...
    const fetchUser = async()=>{
      ...
      try{
        const res = await axios.get("https://important-galoshes-dog.cyclic.cloud/api/private",config);
      ...
      const fetchPosts = async ()=>{
        const res = await axios.get(`https://important-galoshes-dog.cyclic.cloud/api/posts/mail/${user.email}`)
        setPosts(res.data);
      }
      fetchPosts();
  ...
  const handleDelete = async(id)=>{
    ...
    if(ans==="Y" || ans==="y"){
      try{
          await axios.delete(`https://important-galoshes-dog.cyclic.cloud/api/posts/${id}/${user?.email}`);
      }catch(err){
      ...
      {error? <div className='error'>{error}</div>:
        ...
        <div className='profile'>
          ...
          <div className='right'>
            ...
            <div className='joined'>You have joined CodeBlog on {user?.createdAt && user?.createdAt.toString()}</div>
